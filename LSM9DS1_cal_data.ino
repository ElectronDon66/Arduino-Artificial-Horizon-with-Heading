...
Running this will give the gyro offsets. (write them down and put them in the MahoneyuW_AHRS program)
Make two csv files out of the acceleration and magnetometer files and then run them through magneto1_4.c (using code blocks) d= 1, offset =0 
Copy the correction tables (write them down and put them in the MahoneyuW_AHRS program) there will be two 9 element matrices). 
